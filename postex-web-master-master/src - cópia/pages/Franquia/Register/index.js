...
export default class FranquiaRegister extends Component {
    ...
    btn = () => {
        ...
        if (this.state.etapa === 'informacoes'){
                ...
                api.post(constants.franquiacpf, this.state)
                    .then(response => {
                        etapa = 'confirmar';
                    ...
                    <div >
                        ...
                        <div className='contForm'>
                            <div className={this.state.etapa === 'dadospessoais' ? 'dpMeio' : 'dpEsquerda'}>
                                <div className='mid'>
                                    <Row>
                                        <Col md={6} sm={8}><Input label='Nome' t='name' FValue={this.set} Value={this.state.Form1.name}/></Col>
                                        <Col md={3} sm={5}> <Input label='Nascimento' t='nascimento' FValue={this.set} Value={this.state.Form1.nascimento}/></Col>
                                    </Row>
                                    <Row>
                                    ...
                                    <Row>
                                        <Col md={4} sm={8}><Input label='CPF' t='cpf' FValue={this.set} Value={this.state.Form1.cpf} /></Col>
